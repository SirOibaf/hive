...
CREATE TABLE IF NOT EXISTS `COLUMNS_V2` (
  ...
  `TYPE_NAME` VARCHAR(8000) DEFAULT NULL,
  `INTEGER_IDX` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `SD_PARAMS` (
  `SD_ID` bigint(20) NOT NULL,
  `PARAM_KEY` varchar(256) CHARACTER SET latin1 COLLATE latin1_general_cs NOT NULL,
  `PARAM_VALUE` VARCHAR(8000) CHARACTER SET latin1 COLLATE latin1_general_cs DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `TABLE_PARAMS` (
  ...
  KEY `TABLE_PARAMS_N49VARCHAR()` (`TBL_ID`),
  CONSTRAINT `TABLE_PARAMS_FK1` FOREIGN KEY (`TBL_ID`) REFERENCES `TBLS` (`TBL_ID`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE=NDBCLUSTER DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `VIEW_ORG_TEXT`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `VIEW_ORG_TEXT` (
  `TBL_ID` bigint(20) NOT NULL,
  `VIEW_TEXT` VARCHAR(13000) CHARACTER SET latin1 COLLATE latin1_general_cs DEFAULT NULL,
  KEY `VIEW_ORG_TEXT_N49` (`TBL_ID`),
  CONSTRAINT `VIEW_ORG_FK1` FOREIGN KEY (`TBL_ID`) REFERENCES `TBLS` (`TBL_ID`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE=NDBCLUSTER DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `VIEW_EXP_TEXT` (
  `TBL_ID` bigint(20) NOT NULL,
  `VIEW_TEXT` VARCHAR(13000) CHARACTER SET latin1 COLLATE latin1_general_cs DEFAULT NULL,
  KEY `VIEW_ORG_TEXT_N49` (`TBL_ID`),
  CONSTRAINT `VIEW_EXP_FK1` FOREIGN KEY (`TBL_ID`) REFERENCES `TBLS` (`TBL_ID`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE=NDBCLUSTER DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `SCHEMA_VERSION` (
  ...
  `DESCRIPTION` VARCHAR(4000),
  `SCHEMA_TEXT` VARCHAR(8000),
  `FINGERPRINT` VARCHAR(256),
  `SCHEMA_VERSION_NAME` VARCHAR(256),
  `SERDE_ID` bigint, 
  FOREIGN KEY (`SCHEMA_ID`) REFERENCES `I_SCHEMA` (`SCHEMA_ID`) ON DELETE CASCADE ON UPDATE RESTRICT,
  FOREIGN KEY (`CD_ID`) REFERENCES `CDS` (`CD_ID`) ON DELETE CASCADE ON UPDATE RESTRICT,
  FOREIGN KEY (`SERDE_ID`) REFERENCES `SERDES` (`SERDE_ID`) ON DELETE CASCADE ON UPDATE RESTRICT,
...
-- -----------------------------------------------------------------
INSERT INTO VERSION (VER_ID, SCHEMA_VERSION, VERSION_COMMENT) VALUES (1, '3.0.0.3', 'Hive release version 3.0.0.3');
